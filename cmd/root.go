...
var RootCmd = &cobra.Command{
	Use:   "mercurius",
	Short: "Mercurius gives you speed when create 'Go' applications. It lets you being focused at business.",
	Long: `Mercurius gives you speed when create 'Go' applications. It lets you being focused at business.
...
func initConfig() {
	...
	viper.SetConfigName(".mercurius") // name of config file (without extension)
